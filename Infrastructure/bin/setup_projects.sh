...
oc annotate project ${GUID}-nexus      openshift.io/requester=${USER} --overwrite
oc annotate project ${GUID}-sonarqube  openshift.io/requester=${USER} --overwrite
oc annotate project ${GUID}-jenkins    openshift.io/requester=${USER} --overwrite
oc annotate project ${GUID}-parks-dev  openshift.io/requester=${USER} --overwrite
oc annotate project ${GUID}-parks-prod openshift.io/requester=${USER} --overwrite
